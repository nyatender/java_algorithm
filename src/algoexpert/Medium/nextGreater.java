...
wraps around itself as if it were connected end-to-end. So the next index after the last index in
a circular array is the first index. This means that, for our problem, given
...
public class nextGreater {
    public static void main(String[] args) {
        int[] result = nextGreaterElement(new int[]{5,6,6,6,7,-1,5});
        for(int i : result)
            System.out.print(i + " ");
    }
    static public int[] nextGreaterElement(int[] array) {
