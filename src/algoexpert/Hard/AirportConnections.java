...
////                "JFK", "LGA", "LHR", "ORD", "SAN", "SFO", "SIN", "TLV", "BUD"};
        ArrayList<String> airports = new ArrayList<>(Arrays.asList(
                "BGI", "CDG", "DEL", "DOH", "DSM", "EWR", "EYW", "HND", "ICN",
                "JFK", "LGA", "LHR", "ORD", "SAN", "SFO", "SIN", "TLV", "BUD"));

        String[][] routes = {{"DSM", "ORD"},
                {"ORD", "BGI"},
                {"BGI", "LGA"},
                {"SIN", "CDG"},
                {"CDG", "SIN"},
        ...
        List<List<String>> RoutesList = Arrays.stream(routes)
                .map(Arrays::asList)
                .collect(Collectors.toList());
        String startingAirport = "LGA";
        System.out.println(airportConnections(airports, RoutesList, startingAirport));
    }
    ...
    public static void depthFirstAddUnreachableConnections(
            Map<String, AirportNode> airportGraph, String airport,List<String> unreachableConnections,
